              ...
              <div className="hero-details">
                <div>
                  <img
                    ...
                    alt="Ibrahim Hossain"
                    className="img-fluid d-none d-sm-block d-lg-none secondary-hero-img"
                    loading="lazy"
                  />
                  <h1>
                    Ibrahim Hossain
                    <br />
                    <span id="hero-subtitle">WEB Developer</span>
                  </h1>
                  <p className="hero-info-pera">
                    I'm a Bangladeshi front‑end developer focused on crafting
                    clean & user‑friendly experiences, I am passionate about
                    building excellent application that improves the lives of
                    those around me.
                  </p>
                  <div className="row">
