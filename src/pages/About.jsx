              ...
              <div className="col-xl-7">
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <p className="pointIcon">
                      <strong>Full Name : </strong>Md Ibrahim Hossain
                    </p>
                    <p className="pointIcon">
                      <strong>Website : </strong>
                      <a
                        target="_blank"
                        href="https://mdibuhossain.web.app/"
                        rel="noreferrer"
                      >
                        mdibuhossain.web.app
                      </a>
                    </p>
                    <p className="pointIcon">
                  ...
                  <div className="col-md-6">
                    ...
                    <p className="pointIcon">
                      <strong>Degree : </strong>Bechalor of Science in CSE
                    </p>
                    <p className="pointIcon">
                      <strong>Email : </strong>ibuhossain3@gmail.com
                    </p>
                    <p className="pointIcon">
                  ...
                  <div className="col-md-6">
                    <a
                      ...
                      className="mt-2 mb-4 hero-btn rounded-pill"
                      rel="noreferrer"
                    >
                      Download Resume
                ...
                <div className="row g-2">
                  ...
                  <div className="col-sm-6">
                    <div className="border rounded p-3">
                      ...
                      <small>
                        I can create good-looking sites by using ReactJS,
                        MaterialUI
                      </small>
                    </div>
                  </div>
                  <div className="col-sm-6">
                    <div className="border rounded p-3">
                      ...
                      <small>
                        I can create responsive sites by Bootstrap, Tailwind,
                        Vanilla CSS
                      </small>
                    </div>
                  </div>
