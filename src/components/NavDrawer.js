    ...
    <div>
      ...
      <List>
        <NavHashLink
          ...
          className={`${(location.hash === "#top" || location.hash === "/" || location.hash === "") ? activeLinkInnerStyle : linkInnerStyle
            }`}
        >
          Hero
        </NavHashLink>
        <NavHashLink
          smooth
          to="#about"
          className={`${location.hash === "#about" ? activeLinkInnerStyle : linkInnerStyle
            }`}
          onClick={() => handleDrawerToggle(false)}
        >
          About me
        ...
        <NavHashLink
          ...
          to="#portfolio"
          onClick={() => handleDrawerToggle(false)}
          className={`${location.hash === "#portfolio"
            ? activeLinkInnerStyle
            : linkInnerStyle
            }`}
        >
        ...
        smooth 
          ...
          onClick={() => handleDrawerToggle(false)}
          className={({ isActive }) =>
            isActive ? activeLinkInnerStyle : linkInnerStyle
          }
        >
          Blogs
        </NavHashLink> */}
        <NavHashLink
          ...
          to="#contact"
          onClick={() => handleDrawerToggle(false)}
          className={`${location.hash === "#contact" ? activeLinkInnerStyle : linkInnerStyle
            }`}
        >
          Contact me
        </NavHashLink>
